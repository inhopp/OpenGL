...
void Context::Render() {
    ...
    // else {
    //     auto lightModelTransform = glm::translate(glm::mat4(1.0), 
    //                 m_light.position) * glm::scale(glm::mat4(1.0), glm::vec3(0.1f));
